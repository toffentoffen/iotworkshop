...
const String ELASTICSEARCH_HOST     = "";
const String SENSOR_METRICS_DESTINATION = "http://" + String(ELASTICSEARCH_HOST) + ":9200/sensor/measure";
...
void sendSensorData(float temp, float humidity) {
  ...
  String sensorPayload = "{\"sensorID\": " + String(SENSOR_ID) + ",\n\"temperatureCelcius\": " + String(temp) + ",\n\"relativeHumity\": " + String(humidity) + ",\n\"timestamp\": " + currentTimestamp + "\n}";
